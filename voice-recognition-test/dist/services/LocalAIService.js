...
export class LocalAIService {
    ...
    correctText(result) {
        ...
        // 计算纠错置信度
        const confidence = this.calculateCorrectionConfidence(result.text, correctedText, result.confidence, appliedRules.length);
        return {
            correctedText,
     ...
     * 计算纠错置信度
     */
    calculateCorrectionConfidence(originalText, correctedText, originalConfidence, rulesApplied) {
        // 基础置信度从原识别置信度开始
     ...
     * 批量纠错多个候选结果
     */
    correctMultipleResults(results) {
