...
export class HybridVoiceService {
   ...
   * 处理语音识别结果
   */
  private async processResult(result: VoiceRecognitionResult): Promise<void> {
    try {
      let enhancedResult: HybridResult;
   ...
   * 本地优先策略
   */
  private async processLocalFirst(result: VoiceRecognitionResult): Promise<HybridResult> {
    let enhancedResult: HybridResult = { ...result };
   ...
   * AI优先策略
   */
  private async processAIFirst(result: VoiceRecognitionResult): Promise<HybridResult> {
    let enhancedResult: HybridResult = { ...result };
   ...
   * 并行处理策略
   */
  private async processParallel(result: VoiceRecognitionResult): Promise<HybridResult> {
   ...
   * 级联处理策略
   */
  private async processCascade(result: VoiceRecognitionResult): Promise<HybridResult> {
  ...
  private selectBestResult(
    original: VoiceRecognitionResult,
    localResult: any,
    aiResult: any
  ): HybridResult {
    const candidates = [
   ...
   * 调用远程AI API
   */
  private async callRemoteAI(result: VoiceRecognitionResult): Promise<any> {
  ...
  private emitResult(result: VoiceRecognitionResult | HybridResult): void {
